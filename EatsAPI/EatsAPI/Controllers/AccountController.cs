...
namespace EatsAPI.Controllers
{
	...
	public class AccountController : ApiController
	{
		...
		public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
		{
			...
			UserProfile user = await _repo.FindAsync(new UserLoginInfo(externalLogin.LoginProvider, externalLogin.ProviderKey));
		...
		private async Task<ParsedExternalAccessToken> VerifyExternalAccessToken(string provider, string accessToken)
		{
			...
			if (provider == "Facebook")
			{
				...
				var appToken = "399151880243548|vEhjrUZyZbmm_M8Y53KbkLj7V_I";
			...
			{
				verifyTokenEndPoint = string.Format("https://api.twitter.com/oauth/access_token");
			}
			else
			{
				return null;
